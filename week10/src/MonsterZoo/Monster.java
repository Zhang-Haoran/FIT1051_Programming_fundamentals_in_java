...
public class Monster {
	...
	//quasi-mutators - they do reset instance variable values but in a more complicated way
	//than straightforward mutators i.e. more complicated than instVar = param
	//in my opinion they are not mutators
	//single serve eat
